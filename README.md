...
<h1 align="center">
  Building exceptional mobile experiences since 2016
  <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35">
</h1>

<p align='center'>
  <b>Senior Android Developer & Founder at <a href="https://timewarden.app">Timewarden</a></b><br>
  <i>Google Certified • Open Source Maintainer • Speaker</i>
</p>
...
Passionate mobile developer with **8+ years** of experience building production Android applications. Currently leading Android development at **Timewarden** as a Senior Developer and Founder.

I believe in clean code, test-driven development, and sharing knowledge with the community through open source contributions, blog posts, and speaking engagements.

**Quick Facts:**
- 💼 **Senior Android Developer & Founder** at Timewarden
- 📜 **Google Certified Associate Android Developer**
- 🌟 Maintainer of multiple open-source Android libraries
- 📚 Speaker on mobile development & security topics
...
- 💼 **Senior Android Developer & Founder** at Timewarden
- 🏢 Built and shipped multiple production Android applications
- 🎯 Specialized in Clean Architecture, MVVM/MVI, and Kotlin Multiplatform

### Open Source & Community
- 🌟 Maintainer of multiple open-source Android libraries:
  - [RxJava3-Datastore](https://github.com/abd3lraouf/DatastoreWithRxJava3)
  - [CircularProgressBar](https://github.com/abd3lraouf/CircularProgressBar)
  - [FancyAndroidRuler](https://github.com/abd3lraouf/FancyAndroidRuler)
...
- **[Semantic](https://github.com/abd3lraouf/Semantic)** - Semantic search and discovery
- **[Jetpack Compose Challenge #1](https://github.com/abd3lraouf/compose-challenge-1)** - Pet Adoption App with modern UI
- **[Jetpack Compose Challenge #2](https://github.com/abd3lraouf/compose-challenge-2)** - Countdown Timer App
- **[WeeTwit](https://github.com/abd3lraouf/WeeTwit)** - Twitter Search application

### Open Source Libraries
As a maintainer, I actively develop and support:
...
### Presentations
- [Social Engineering](https://abd3lraouf.github.io/social-engineering/), 26th April 2020 @ ITI
...
⏳ **Year Progress** { █▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁ } 3.81 % as on ⏰ 15-1-2026.

---

## 🤝 Let's Connect

I'm always interested in collaborating on innovative mobile projects and connecting with fellow developers.
...
<p align='center'>
  ...
  <a href="mailto:hello@abd3lraouf.dev">
    <img src="https://img.shields.io/badge/hello@abd3lraouf.dev-34A853?style=for-the-badge&logo=gmail&logoColor=white" alt="Email for other inquiries">
  </a>
</p>
